...
Issues are managed on [GitHub](https://github.com/milenmk/laravel-blacklist/issues).
...
1. [Fork](https://help.github.com/articles/fork-a-repo)
   the [GitHub repository](https://github.com/milenmk/laravel-blacklist).
2. Clone your fork.
...
the [Packages documentation site](https://minkov.dev/laravel-blacklist/documentation).
